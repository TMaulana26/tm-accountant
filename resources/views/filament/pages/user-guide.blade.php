<x-filament-panels::page>
    <div class="space-y-8 font-sans">
        ...
        <div class="bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 p-6 space-y-6">
            <div class="border-b border-slate-200 dark:border-slate-800 pb-4">
                <div class="flex items-center gap-3">
                    <div class="p-2.5 rounded-xl bg-blue-50 dark:bg-blue-950/50 text-blue-600 dark:text-blue-400 border border-blue-200 dark:border-blue-800/60">
                        <x-filament::icon icon="heroicon-o-chat-bubble-left-right" class="h-6 w-6" />
                    </div>
                    <div>
                        <h3 class="text-lg font-bold text-slate-900 dark:text-white">1. Panduan & Tata Cara Bot Telegram</h3>
                        <p class="text-xs text-slate-500 dark:text-slate-400">Cara mencatat pengeluaran, pemasukan, dan cek saldo cukup lewat chat santai</p>
                    </div>
                </div>
            </div>

            <!-- Cara Menjalankan Bot -->
            <div class="bg-slate-50 dark:bg-slate-800/40 rounded-xl p-4 border border-slate-200 dark:border-slate-700/60">
                ...
                <div class="mt-2 bg-slate-900 dark:bg-black text-emerald-400 font-mono text-xs p-3 rounded-lg flex justify-between items-center border border-slate-800">
                    <code>php artisan telegram:poll</code>
                    <span class="text-[10px] text-slate-400">Ctrl + C untuk stop</span>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
                <!-- Pengeluaran -->
                <div class="p-4 rounded-xl border border-rose-200 dark:border-rose-900/60 bg-rose-50/50 dark:bg-rose-950/30 space-y-2">
                    <span class="font-bold text-rose-700 dark:text-rose-400 uppercase tracking-wider text-[11px] flex items-center gap-1.5">
                        🔴 Mencatat Pengeluaran (Expense)
                    </span>
                    <p class="text-slate-600 dark:text-slate-300">Cukup ketik apa yang Anda beli, nominal, dan opsional metode bayar:</p>
                    <ul class="space-y-1 font-mono text-slate-800 dark:text-slate-200 list-disc list-inside">
                ...
                <!-- Pemasukan -->
                <div class="p-4 rounded-xl border border-emerald-200 dark:border-emerald-900/60 bg-emerald-50/50 dark:bg-emerald-950/30 space-y-2">
                    <span class="font-bold text-emerald-700 dark:text-emerald-400 uppercase tracking-wider text-[11px] flex items-center gap-1.5">
                        🟢 Mencatat Pemasukan (Income)
                    </span>
                    <p class="text-slate-600 dark:text-slate-300">Ketik sumber pemasukan dan rekening penerima:</p>
                    <ul class="space-y-1 font-mono text-slate-800 dark:text-slate-200 list-disc list-inside">
                ...
                <!-- Transfer Antar Akun -->
                <div class="p-4 rounded-xl border border-blue-200 dark:border-blue-900/60 bg-blue-50/50 dark:bg-blue-950/30 space-y-2">
                    ...
                    <p class="text-slate-600 dark:text-slate-300">Pindah buku antar kas atau rekening bank:</p>
                    <ul class="space-y-1 font-mono text-slate-800 dark:text-slate-200 list-disc list-inside">
                ...
                <!-- Tanya Saldo & Laporan -->
                <div class="p-4 rounded-xl border border-purple-200 dark:border-purple-900/60 bg-purple-50/50 dark:bg-purple-950/30 space-y-2">
                    ...
                    <p class="text-slate-600 dark:text-slate-300">Minta AI merangkum keuangan Anda:</p>
                    <ul class="space-y-1 font-mono text-slate-800 dark:text-slate-200 list-disc list-inside">
        ...
        <div class="bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 p-6 space-y-6">
            <div class="border-b border-slate-200 dark:border-slate-800 pb-4">
                <div class="flex items-center gap-3">
                    <div class="p-2.5 rounded-xl bg-purple-50 dark:bg-purple-950/50 text-purple-600 dark:text-purple-400 border border-purple-200 dark:border-purple-800/60">
                        <x-filament::icon icon="heroicon-o-wallet" class="h-6 w-6" />
                    </div>
                    <div>
                        <h3 class="text-lg font-bold text-slate-900 dark:text-white">2. Panduan Kelola Dompet, Rekening, & Saldo Awal</h3>
                        <p class="text-xs text-slate-500 dark:text-slate-400">Cara mengatur dompet tunai, rekening bank, e-wallet, saldo awal, dan dompet default</p>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 p-6 space-y-6">
            <div class="border-b border-slate-200 dark:border-slate-800 pb-4">
                <div class="flex items-center gap-3">
                    <div class="p-2.5 rounded-xl bg-emerald-50 dark:bg-emerald-950/50 text-emerald-600 dark:text-emerald-400 border border-emerald-200 dark:border-emerald-800/60">
                        <x-filament::icon icon="heroicon-o-document-chart-bar" class="h-6 w-6" />
                    </div>
                    <div>
                        <h3 class="text-lg font-bold text-slate-900 dark:text-white">3. Membaca Laporan Keuangan (Standar Mekari Jurnal)</h3>
                        <p class="text-xs text-slate-500 dark:text-slate-400">Penjelasan arti dan fungsi masing-masing submenu pada Laporan Keuangan</p>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 p-6 space-y-4">
            <div class="border-b border-slate-200 dark:border-slate-800 pb-4">
                <div class="flex items-center gap-3">
                    <div class="p-2.5 rounded-xl bg-slate-50 dark:bg-slate-800 text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-slate-700">
                        <x-filament::icon icon="heroicon-o-cloud-arrow-up" class="h-6 w-6" />
                    </div>
                    <div>
                        <h3 class="text-lg font-bold text-slate-900 dark:text-white">4. Setup Webhook untuk Server / VPS Cloud</h3>
                        <p class="text-xs text-slate-500 dark:text-slate-400">Menjalankan bot 24/7 tanpa perlu terminal polling</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-slate-900 dark:bg-black text-emerald-400 font-mono text-xs p-4 rounded-xl overflow-x-auto border border-slate-800">
